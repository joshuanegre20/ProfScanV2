...
const TabLoadingFallback = () => (
  <div style={{ display: "flex", justifyContent: "center", alignItems: "center", padding: "3rem" }}>
    <div style={{ width: "2rem", height: "2rem", border: "2px solid rgba(234,179,8,0.2)", borderTopColor: "#eab308", borderRadius: "50%", animation: "spin 0.7s linear infinite" }} />
...
const PageLoadingScreen = () => (
  <div style={{
    ...
    minHeight: "100vh", background: "#003366", gap: "1.25rem",
  }}>
    <div style={{
      width: "3.5rem", height: "3.5rem",
      border: "3px solid rgba(234,179,8,0.25)", borderTopColor: "#eab308",
      borderRadius: "50%", animation: "spin 0.7s linear infinite",
    }} />
    <div style={{ textAlign: "center" }}>
      <p style={{ color: "#eab308", fontSize: "1rem", fontWeight: 600, margin: 0 }}>Loading Dashboard</p>
      <p style={{ color: "rgba(234,179,8,0.5)", fontSize: "0.75rem", margin: "0.25rem 0 0" }}>Trinidad Municipal College</p>
    </div>
    <style>{`@keyframes spin { to { transform: rotate(360deg); } }`}</style>
  </div>
);
    ...
    <div style={{ display: "flex", minHeight: "100vh", background: "#003366" }}>
      <aside
        style={{
          ...
          scrollbarWidth: "thin", scrollbarColor: "#4a3a00 #eab308",
        }}
      >
        <style>{`
          aside::-webkit-scrollbar { width: 6px; height: 6px; }
          aside::-webkit-scrollbar-track { background: #eab308; border-radius: 3px; }
          aside::-webkit-scrollbar-thumb { background: #7a5c00; border-radius: 3px; }
          aside::-webkit-scrollbar-thumb:hover { background: #4a3a00; }
          aside::-webkit-scrollbar-corner { background: #eab308; }
        `}</style>
        ...
        <div style={{
          ...
          borderBottom: "1px solid rgba(0,0,0,0.1)", marginBottom: "1rem",
        }}>
          {logoUrl ? (
              ...
              <div key={groupKey} style={{ marginBottom: "1rem" }}>
                <button
                  ...
                  style={{
                    ...
                    padding: "0.75rem 0.5rem", background: "transparent", border: "none",
                    color: "#4a3a00", cursor: "pointer", borderRadius: "0.5rem",
                    ...
                    {tabsInGroup.map(tab => (
                      <button
                        ...
                        style={{
                          ...
                          gap: "0.75rem", padding: sidebarCollapsed ? "0.75rem 0" : "0.75rem 1rem",
                        ...
                        onMouseEnter={(e) => { if (activeTab !== tab.key) e.currentTarget.style.background = "rgba(0,0,0,0.08)"; }}
        ...
        {/* Footer */}
        <div style={{ padding: "1rem 0.75rem", borderTop: "1px solid rgba(0,0,0,0.1)", marginTop: "auto" }}>
          <button
            onClick={() => setSidebarCollapsed(!sidebarCollapsed)}
            style={{
              width: "100%", display: "flex", alignItems: "center",
              justifyContent: sidebarCollapsed ? "center" : "flex-start",
              gap: "0.75rem", padding: "0.75rem", background: "rgba(0,0,0,0.05)",
              border: "none", borderRadius: "0.5rem", cursor: "pointer",
              color: "#4a3a00", fontSize: "0.875rem", marginBottom: "0.5rem",
            }}
          >
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                background: "rgba(0,0,0,0.08)", border: "none", borderRadius: "0.5rem",
                padding: sidebarCollapsed ? "0.5rem" : "0.5rem 0.75rem",
                cursor: "pointer", color: "#4a3a00", display: "flex",
                alignItems: "center", gap: "0.5rem", fontSize: "0.75rem", transition: "all 0.2s",
              }}
      ...
      {/* Main Content */}
      <main style={{
        flex: 1, marginLeft: sidebarCollapsed ? "80px" : "280px",
        transition: "margin-left 0.3s ease", minHeight: "100vh", background: "#003366",
      }}>
