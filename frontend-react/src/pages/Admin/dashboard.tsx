          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.625rem" }}>
            ...
            <div ref={addRef} style={{ position: "relative" }}>
              <button
                ...
                title="Add"
                style={{
                  background: ADD_KEYS.includes(activeTab) || addOpen ? "#4338ca" : "#312e81",
              ...
              {addOpen && (
                <div style={{ position: "absolute", top: "calc(100% + 8px)", right: 0, background: "#fff", border: "1px solid #e5e7eb", borderRadius: "0.5rem", boxShadow: "0 10px 15px -3px rgba(0,0,0,0.15)", minWidth: "160px", zIndex: 50, overflow: "hidden" }}>
                  {addDropdownItems.map((item, idx) => (
                    <button
                      key={item.key}
                      onClick={() => handleAddItemClick(item.key)}
                      style={{
                        width: "100%", display: "flex", alignItems: "center", gap: "0.6rem",
                        padding: "0.625rem 1rem", border: "none",
                        borderBottom: idx < addDropdownItems.length - 1 ? "1px solid #f3f4f6" : "none",
                        background: activeTab === item.key ? "#eef2ff" : "#fff",
                        color: activeTab === item.key ? "#4f46e5" : "#374151",
                        fontSize: "0.875rem", fontWeight: activeTab === item.key ? 600 : 400,
                    ...
                    >
                      ...
                      {activeTab === item.key && (
                        <span style={{ marginLeft: "auto" }}>
                          <svg width="14" height="14" fill="none" stroke="#4f46e5" strokeWidth="3" viewBox="0 0 24 24">
            ...
            <div ref={settingsRef} style={{ position: "relative" }}>
              <button
                ...
                title="Settings"
                style={{
                  background: SETTINGS_KEYS.includes(activeTab) || settingsOpen ? "#4338ca" : "#312e81",
                  border: "none", color: "#fff",
                  width: "2.25rem", height: "2.25rem",
                  borderRadius: "0.5rem", cursor: "pointer",
                  display: "flex", alignItems: "center", justifyContent: "center", padding: 0,
                  ...
                  {settingsDropdownItems.map((item, idx) => (
                    <button
                      ...
                      style={{
                        width: "100%", display: "flex", alignItems: "center", gap: "0.6rem",
                        padding: "0.625rem 1rem", border: "none",
                        borderBottom: idx < settingsDropdownItems.length - 1 ? "1px solid #f3f4f6" : "none",
                        background: activeTab === item.key ? "#eef2ff" : "#fff",
                        color: activeTab === item.key ? "#4f46e5" : "#374151",
                        fontSize: "0.875rem", fontWeight: activeTab === item.key ? 600 : 400,
                        cursor: "pointer", textAlign: "left",
